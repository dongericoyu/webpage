...
1.  **Identify your experimental variables** (IV and DV) from the survey

2.  Write the code to recode your group's IVs and DVs in a proper form using `mutate()` + `case_when()`.
