...
```{r}
library(readr)
electric <- read_csv("Legal393E_Notes/data/API_EG.ELC.ACCS.ZS_DS2_en_csv_v2_76137.csv", 
    skip = 3)
...
```{r}
#using dplyr packages (a tidyverse family package)to help to edit and change dataset.
library(dplyr)
